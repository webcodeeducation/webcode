...
class Fees extends React.Component {
   ...
   this.setState({ 
	...
	var opt = sdata.map((sdata) => newArray.push({id:sdata.id,name:sdata.name,value:sdata.name}));
  ...
  <div className="panel panel-primary">
	...
	//<SelectSearch options={newArray} value="sv" name="language" placeholder="Select Student" onChange = {(e)=>this.setState({sid:e.target.value})}/>
