...
class Reminder extends React.Component {
    ...
    axios.post('https://exlraethealth.in/backend/api/fetchStudentDetails', { student })
      .then(res => {
        console.log(res);
        //console.log(res.data);
			...
			.then(data => {console.log(data.student_data);this.setState({sdata:data.student_data,cdata:data.course_data,feesdata:data.fees_data,totalcount:data.fees_data.length,email:data.student_data.email,phone:data.student_data.phone,isLoading:false})});
  ...
  <div className="cv-spinner">
    <span className="spinner"></span>
	  ...
	  {myloader}
		...
		<label>To:</label>
		<input type="text" name="to" className="form-control" value={this.state.email} autoComplete="nope"/>
		</div>
		<div className="form-group">
		<label>Cc:</label>
	<input type="text" name="cc" className="form-control" onChange = {(e)=>this.setState({cc:e.target.value})} value={this.state.cc} autoComplete="nope"/>
		</div>
		<div className="form-group">
		<label>Bcc:</label>
		<input type="text" name="bcc" className="form-control" onChange = {(e)=>this.setState({bcc:e.target.value})} value={this.state.bcc} autoComplete="nope"/>
		</div>
		<div className="form-group">
		<label>Subject:</label>
		<input type="text" name="subject" className="form-control" onChange = {(e)=>this.setState({subject:e.target.value})} value={this.state.subject} autoComplete="nope"/>
		</div>
		<div className="form-group">
  ...
  dateFormat="Pp"/>
		...
		<input type="text" name="total_fees" className="form-control" value={this.state.sdata.fees} disabled="disabled"/>
		</div>
		<div className="form-group">
		<label>Fees:</label>
		<input type="number" name="fees" className="form-control" onChange = {(e)=>this.setState({fees:e.target.value})} value={this.state.fees} autoComplete="nope"/>
		</div>
		<div className="form-group">
		...
		<input type="reset" value="Reset"  className="btn btn-warning"/>
		  ...
		  <tr><td>Name</td><td>{this.state.sdata.first_name} {this.state.sdata.last_name}</td></tr>
		  <tr><td>Contact</td><td>{this.state.sdata.phone}</td></tr>
		  <tr><td>Email</td><td>{this.state.sdata.email}</td></tr>
		  <tr><td>Father</td><td>{this.state.sdata.father_name}</td></tr>
		  <tr><td>Father Contact</td><td>{this.state.sdata.father_contact}</td></tr>
		  <tr><td>DOB</td><td>{this.state.sdata.dob}</td></tr>
		  <tr><td>Course</td><td>{this.state.cdata.course_title}</td></tr>
		  <tr><td>Fees</td><td>{this.state.sdata.fees}</td></tr>
		  <tr><td>Admission Date:</td><td>{this.state.sdata.created_at}</td></tr>
		  </table>
		  </Col>
		  </Row>
